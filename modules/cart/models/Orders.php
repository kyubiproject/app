...
class Orders extends ActiveRecord
{
    ...
    {
        return $this->hasOne(Coupons::className(), ['id' => 'cart_coupons_id']);
    }
    ...
    {
        return $this->hasOne(Gateways::className(), ['id' => 'gateways_id']);
    }
    ...
    {
        return $this->hasMany(OrdersItems::className(), ['cart_order_id' => 'id']);
    }
