...
!(function(root, factory) {
  ...
  function lockScreen() {
    ...
    if (!$html.hasClass(lockedClass)) {
      ...
      $isStuck.css('padding-right', paddingRight + 'px');
...
$window.on('load', function () {
	...
	function createMap(id, mapZoom) {
		...
		var marker = new google.maps.Marker({
			position: new google.maps.LatLng(40.463667, -3.74922),
			map: map,
			icon: image
		});
...
//var jscroll=require('jquery.jscroll.js');
 //$('ul.pagination').hide();
