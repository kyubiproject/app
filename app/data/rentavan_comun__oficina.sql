...
--
-- Dumping data for table `comun__oficina`
--

LOCK TABLES `comun__oficina` WRITE;
/*!40000 ALTER TABLE `comun__oficina` DISABLE KEYS */;
/*!40000 ALTER TABLE `comun__oficina` ENABLE KEYS */;
UNLOCK TABLES;
