...
--
-- Dumping data for table `tarifa__periodo`
--

LOCK TABLES `tarifa__periodo` WRITE;
/*!40000 ALTER TABLE `tarifa__periodo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tarifa__periodo` ENABLE KEYS */;
UNLOCK TABLES;
