...
--
-- Dumping data for table `comun__persona`
--

LOCK TABLES `comun__persona` WRITE;
/*!40000 ALTER TABLE `comun__persona` DISABLE KEYS */;
/*!40000 ALTER TABLE `comun__persona` ENABLE KEYS */;
UNLOCK TABLES;
