...
--
-- Dumping data for table `comun__persona_contacto`
--

LOCK TABLES `comun__persona_contacto` WRITE;
/*!40000 ALTER TABLE `comun__persona_contacto` DISABLE KEYS */;
/*!40000 ALTER TABLE `comun__persona_contacto` ENABLE KEYS */;
UNLOCK TABLES;
