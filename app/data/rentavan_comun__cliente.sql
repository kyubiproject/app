...
--
-- Dumping data for table `comun__cliente`
--

LOCK TABLES `comun__cliente` WRITE;
/*!40000 ALTER TABLE `comun__cliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `comun__cliente` ENABLE KEYS */;
UNLOCK TABLES;
