...
--
-- Dumping data for table `comun__delegacion`
--

LOCK TABLES `comun__delegacion` WRITE;
/*!40000 ALTER TABLE `comun__delegacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `comun__delegacion` ENABLE KEYS */;
UNLOCK TABLES;
