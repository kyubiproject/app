...
--
-- Dumping data for table `flota__vehiculo_observacion`
--

LOCK TABLES `flota__vehiculo_observacion` WRITE;
/*!40000 ALTER TABLE `flota__vehiculo_observacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `flota__vehiculo_observacion` ENABLE KEYS */;
UNLOCK TABLES;
