...
/**
 * This is the model class for table "DailySubstate_api".
 *
 ...
 */
class DailySubstateApi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['FECHA_EXTRACCION', 'FECHA_CREATED', 'FECHA_CREATED_DATE', 'FECHA_SUBSTATE_DATE', 'FECHA_PRINTED_DATE', 'FECHA_MODIFICACION', 'FECHA_FIN', 'FECHA_ESTADO_SEUR', 'QA_FECHA_ANALISIS'], 'safe'],
            [['CONTRACT_ID', 'GUID', 'STATE', 'SUBSTATE'], 'required'],
            [['CONTRACT_ID', 'STATE', 'SUBSTATE', 'COD_PROVINCIA', 'SEUR_FRANQUICIA', 'SEUR_CARGA_MANUAL_ORIGEN', 'SEUR_CARGA_MANUAL_FINAL', 'CERT_LOGALTY', 'CLEANED', 'upload_id'], 'integer'],
            [['CERT_SEUR'], 'string'],
