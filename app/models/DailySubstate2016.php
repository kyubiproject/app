...
/**
 * This is the model class for table "DailySubstate_2016".
 *
 * @property int $id
 ...
 */
class DailySubstate2016 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'CONTRACT_ID', 'GUID', 'STATE', 'SUBSTATE'], 'required'],
