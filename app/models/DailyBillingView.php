...
/**
 * This is the model class for table "DailyBillingView".
 *
 * @property int $id
 ...
 */
class DailyBillingView extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'EMISOR_ID', 'L_FACTURABLE', 'UD', 'PAQ_TX_MAX', 'PAQ_TX', 'PAQ_CUOTAS', 'deleted', 'upload_id'], 'integer'],
            [['FECHA', 'EMISOR_ID', 'FACTURACION_TIPO', 'TIPO', 'UD', 'PRECIO', 'IMPORTE', 'upload_id'], 'required'],
