...
/**
 * This is the model class for table "DailySubstate_2014".
 *
 * @property int $id
 * @property string $FECHA_EXTRACCION
 * @property int $CONTRACT_ID
 * @property string $EMISOR
 * @property string $EMISOR_DELEGATE
 ...
 * @property string|null $SUBSTATE_COMMENT
 ...
 * @property int $SEUR_FRANQUICIA
 * @property int $SEUR_CARGA_MANUAL_ORIGEN
 * @property int $SEUR_CARGA_MANUAL_FINAL
 * @property int $CERT_LOGALTY
 * @property string $CERT_SEUR
 * @property string|null $QA_FECHA_ANALISIS
 * @property string $QA_FDD_TIPO
 * @property string $QA_FDD_DESCRIPCION
 * @property string $QA_FDD_CLASIFICACION
 * @property string|null $CONVERSION
 * @property int $CLEANED
 * @property int $deleted
 * @property string|null $updated_at
 * @property int $upload_id
 */
class DailySubstate2014 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
