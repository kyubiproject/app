...
/**
 * This is the model class for table "DailySubstateElec_api".
 *
 ...
 */
class DailySubstateElecApi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['EMISOR', 'NODE_ID', 'CONTRACT_ID', 'TX_TIPO', 'SERVICIO', 'STATE', 'SUBSTATE', 'DOC_COUNT', 'FIRMANTES', 'upload_id'], 'required'],
            [['NODE_ID', 'CONTRACT_ID', 'STATE', 'SUBSTATE', 'SYNCRONO', 'DOC_COUNT', 'FIRMANTES', 'TAMANIO', 'PIN_COUNT', 'PIN_SMS', 'PIN_VOZ', 'TIME2CLOSE', 'TIME2SAVE', 'RETRIES', 'ENFORCE_DOWNLOAD', 'ACCESS_TIME', 'SIGN_TIME', 'CLOSE_TIME', 'TX_TIME', 'upload_id'], 'integer'],
